            ...
            try
            {
                ...
                connection.Open();
                 ...
                 string insert = "INSERT INTO venda(ven_data,ven_total_liq,ven_total_bruto,ven_status,desc_venda,cli_cod,func_cod,cod_prod,ven_horario)  values  ('" + lSell.sellDate + "','" + lSell.sellNetAmount.Replace(",", ".") +
                    "','" + lSell.sellGrossAmount.Replace(",", ".") + "','" + lSell.sellStatus + "','" + lSell.sellDiscount.Replace(",", ".") + "','" + lClient.clientId + "','"  + lEmployee.employeeId + "','" + lProduct.prodCodigo + "','" + lSell.sellHour + "')";
        ...
        public void ItemSellMethod(Product lProduct,Sell lSell, ItemSell lItemSell)
        {
            try
            {
                ...
                connection.Open();
                 ...
                 string insert = "INSERT INTO item_venda(id_prod,Qtde_prod,Valor_Venda,total_item,id_venda) values ('" + lProduct.prodCodigo + "','" + lItemSell.itemQuantity + "','" + lProduct.prodPrecoVenda + "','" + lItemSell.itemTotal + "','" + lSell.sellId + "')";
                MySqlCommand command = new MySqlCommand(insert, connection);
                MySqlDataReader myreader;
                myreader = command.ExecuteReader();
            }
